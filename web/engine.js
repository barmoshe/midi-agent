...
// Dual export: CommonJS (Node oracle + Max v8 bundle) and a browser/global (the web app).
if (typeof module !== 'undefined' && module.exports) { module.exports = ENGINE_API; }
if (typeof globalThis !== 'undefined') { globalThis.MidiEngine = ENGINE_API; }
